      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className={`relative w-full max-w-lg bg-surface border border-border-token/40 rounded-3xl overflow-hidden shadow-2xl z-10 flex flex-col max-h-[90vh] ${className}`}
          >
            {/* Header */}
