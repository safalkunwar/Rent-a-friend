...
export const COMPANIONS: Companion[] = [
  ...
  },
  {
    ...
    age: 28,
    gender: 'Male',
    bio: "Passionate about trekking, mountain biking, and exploring the hidden gems of Pokhara. I can be your ultimate guide to the Annapurna region and best lakeside cafes.",
    hourlyRate: 22,
    rating: 5.0,
    reviewsCount: 156,
    isVerified: true,
