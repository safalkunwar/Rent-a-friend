...
- **Registration details:** Name, email, profile image, phone number.
- **Companion Application details:** Location, hourly rates, bio, identity document uploads, languages, interests.
- **Booking and Messaging details:** Dates, booking parameters, text messages, notification histories, payment references.
